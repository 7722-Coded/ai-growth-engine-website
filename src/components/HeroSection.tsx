  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-white to-accent pt-20">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-primary-light opacity-10 rounded-full blur-3xl transform transition-all duration-1000 animate-pulse"></div>
        <div className="absolute top-1/2 -left-40 w-96 h-96 bg-primary opacity-10 rounded-full blur-3xl transform transition-all duration-1000 delay-500 animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-64 h-64 bg-accent opacity-20 rounded-full blur-3xl transform transition-all duration-1000 delay-700 animate-pulse"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-12 lg:mb-0">
            <div className={`max-w-xl space-y-6 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 transition-all duration-700 delay-500 transform" style={{
                ...
                <Button 
                  className="bg-primary hover:bg-primary-dark text-white text-lg px-8 py-6 rounded-lg transform transition-transform hover:scale-105"
          ...
          <div className="lg:w-1/2 flex justify-center">
            <div className={`glass-card p-4 rounded-xl transition-all duration-1000 delay-200 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
              <div className="relative">
                <div className="w-full h-full absolute -top-3 -left-3 border-2 border-primary rounded-xl transform transition-all hover:scale-105 hover:-translate-x-1 hover:-translate-y-1 duration-300"></div>
                <img 
                ...
                <div className="absolute -bottom-5 -right-5 bg-white p-3 rounded-lg shadow-lg animate-float">
                  <div className="bg-primary text-white p-3 rounded-lg transform transition-transform hover:scale-105">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 transition-opacity duration-700 delay-1000" style={{
        ...
        >
          ...
          <div className="w-6 h-10 border-2 border-current rounded-full flex items-center justify-center group">
            <div className="w-1.5 h-3 bg-current rounded-full animate-bounce group-hover:animate-pulse"></div>
          </div>
        </button>
      </div>
    </section>
